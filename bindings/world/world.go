...
//
// Solidity: function eveworld__aggression(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactor) EveworldAggression(opts *bind.TransactOpts, smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__aggression", smartTurretId, turretOwnerCharacterId, priorityQueue, turret, aggressor, victim)
}

// EveworldAggression is a paid mutator transaction binding the contract method 0xcbabbe17.
//
// Solidity: function eveworld__aggression(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldSession) EveworldAggression(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldAggression(&_World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, aggressor, victim)
}

// EveworldAggression is a paid mutator transaction binding the contract method 0xcbabbe17.
//
// Solidity: function eveworld__aggression(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactorSession) EveworldAggression(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldAggression(&_World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, aggressor, victim)
}
...
//
// Solidity: function eveworld__createAndAnchorSmartStorageUnit(uint256 smartStorageUnitId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 storageCapacity, uint256 ephemeralStorageCapacity) returns()
func (_World *WorldTransactor) EveworldCreateAndAnchorSmartStorageUnit(opts *bind.TransactOpts, smartStorageUnitId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createAndAnchorSmartStorageUnit", smartStorageUnitId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}

// EveworldCreateAndAnchorSmartStorageUnit is a paid mutator transaction binding the contract method 0xa1353e41.
//
// Solidity: function eveworld__createAndAnchorSmartStorageUnit(uint256 smartStorageUnitId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 storageCapacity, uint256 ephemeralStorageCapacity) returns()
func (_World *WorldSession) EveworldCreateAndAnchorSmartStorageUnit(smartStorageUnitId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartStorageUnit(&_World.TransactOpts, smartStorageUnitId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}

// EveworldCreateAndAnchorSmartStorageUnit is a paid mutator transaction binding the contract method 0xa1353e41.
//
// Solidity: function eveworld__createAndAnchorSmartStorageUnit(uint256 smartStorageUnitId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 storageCapacity, uint256 ephemeralStorageCapacity) returns()
func (_World *WorldTransactorSession) EveworldCreateAndAnchorSmartStorageUnit(smartStorageUnitId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartStorageUnit(&_World.TransactOpts, smartStorageUnitId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}
...
//
// Solidity: function eveworld__createAndDepositItemsToEphemeralInventory(uint256 smartStorageUnitId, address ephemeralInventoryOwner, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_World *WorldTransactor) EveworldCreateAndDepositItemsToEphemeralInventory(opts *bind.TransactOpts, smartStorageUnitId *big.Int, ephemeralInventoryOwner common.Address, items []InventoryItem) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createAndDepositItemsToEphemeralInventory", smartStorageUnitId, ephemeralInventoryOwner, items)
}

// EveworldCreateAndDepositItemsToEphemeralInventory is a paid mutator transaction binding the contract method 0x88633ae4.
//
// Solidity: function eveworld__createAndDepositItemsToEphemeralInventory(uint256 smartStorageUnitId, address ephemeralInventoryOwner, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_World *WorldSession) EveworldCreateAndDepositItemsToEphemeralInventory(smartStorageUnitId *big.Int, ephemeralInventoryOwner common.Address, items []InventoryItem) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndDepositItemsToEphemeralInventory(&_World.TransactOpts, smartStorageUnitId, ephemeralInventoryOwner, items)
}

// EveworldCreateAndDepositItemsToEphemeralInventory is a paid mutator transaction binding the contract method 0x88633ae4.
//
// Solidity: function eveworld__createAndDepositItemsToEphemeralInventory(uint256 smartStorageUnitId, address ephemeralInventoryOwner, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_World *WorldTransactorSession) EveworldCreateAndDepositItemsToEphemeralInventory(smartStorageUnitId *big.Int, ephemeralInventoryOwner common.Address, items []InventoryItem) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndDepositItemsToEphemeralInventory(&_World.TransactOpts, smartStorageUnitId, ephemeralInventoryOwner, items)
}

// EveworldCreateAndDepositItemsToInventory is a paid mutator transaction binding the contract method 0xd6f49960.
//
// Solidity: function eveworld__createAndDepositItemsToInventory(uint256 smartStorageUnitId, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_World *WorldTransactor) EveworldCreateAndDepositItemsToInventory(opts *bind.TransactOpts, smartStorageUnitId *big.Int, items []InventoryItem) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createAndDepositItemsToInventory", smartStorageUnitId, items)
}

// EveworldCreateAndDepositItemsToInventory is a paid mutator transaction binding the contract method 0xd6f49960.
//
// Solidity: function eveworld__createAndDepositItemsToInventory(uint256 smartStorageUnitId, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_World *WorldSession) EveworldCreateAndDepositItemsToInventory(smartStorageUnitId *big.Int, items []InventoryItem) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndDepositItemsToInventory(&_World.TransactOpts, smartStorageUnitId, items)
}

// EveworldCreateAndDepositItemsToInventory is a paid mutator transaction binding the contract method 0xd6f49960.
//
// Solidity: function eveworld__createAndDepositItemsToInventory(uint256 smartStorageUnitId, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_World *WorldTransactorSession) EveworldCreateAndDepositItemsToInventory(smartStorageUnitId *big.Int, items []InventoryItem) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndDepositItemsToInventory(&_World.TransactOpts, smartStorageUnitId, items)
}
...
//
// Solidity: function eveworld__inProximity(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactor) EveworldInProximity(opts *bind.TransactOpts, smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__inProximity", smartTurretId, turretOwnerCharacterId, priorityQueue, turret, turretTarget)
}

// EveworldInProximity is a paid mutator transaction binding the contract method 0x238d7ca6.
//
// Solidity: function eveworld__inProximity(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldSession) EveworldInProximity(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldInProximity(&_World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, turretTarget)
}

// EveworldInProximity is a paid mutator transaction binding the contract method 0x238d7ca6.
//
// Solidity: function eveworld__inProximity(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactorSession) EveworldInProximity(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldInProximity(&_World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, turretTarget)
}

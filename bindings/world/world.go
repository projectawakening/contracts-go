...
// EvefrontierConnectAssemblies is a paid mutator transaction binding the contract method 0xd20c9f99.
//
// Solidity: function evefrontier__connectAssemblies(uint256 networkNodeId, uint256[] assemblyIds) returns()
func (_World *WorldTransactor) EvefrontierConnectAssemblies(opts *bind.TransactOpts, networkNodeId *big.Int, assemblyIds []*big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__connectAssemblies", networkNodeId, assemblyIds)
}

// EvefrontierConnectAssemblies is a paid mutator transaction binding the contract method 0xd20c9f99.
//
// Solidity: function evefrontier__connectAssemblies(uint256 networkNodeId, uint256[] assemblyIds) returns()
func (_World *WorldSession) EvefrontierConnectAssemblies(networkNodeId *big.Int, assemblyIds []*big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierConnectAssemblies(&_World.TransactOpts, networkNodeId, assemblyIds)
}

// EvefrontierConnectAssemblies is a paid mutator transaction binding the contract method 0xd20c9f99.
//
// Solidity: function evefrontier__connectAssemblies(uint256 networkNodeId, uint256[] assemblyIds) returns()
func (_World *WorldTransactorSession) EvefrontierConnectAssemblies(networkNodeId *big.Int, assemblyIds []*big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierConnectAssemblies(&_World.TransactOpts, networkNodeId, assemblyIds)
}

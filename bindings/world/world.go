...
// EveworldCalculatDistance is a free data retrieval call binding the contract method 0xbc9ae939.
//
// Solidity: function eveworld__calculatDistance(uint256 sourceGateId, uint256 destinationGateId) view returns(uint256)
func (_World *WorldCaller) EveworldCalculatDistance(opts *bind.CallOpts, sourceGateId *big.Int, destinationGateId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _World.contract.Call(opts, &out, "eveworld__calculatDistance", sourceGateId, destinationGateId)
...
//
// Solidity: function eveworld__calculatDistance(uint256 sourceGateId, uint256 destinationGateId) view returns(uint256)
func (_World *WorldSession) EveworldCalculatDistance(sourceGateId *big.Int, destinationGateId *big.Int) (*big.Int, error) {
	return _World.Contract.EveworldCalculatDistance(&_World.CallOpts, sourceGateId, destinationGateId)
}

// EveworldCalculatDistance is a free data retrieval call binding the contract method 0xbc9ae939.
//
// Solidity: function eveworld__calculatDistance(uint256 sourceGateId, uint256 destinationGateId) view returns(uint256)
func (_World *WorldCallerSession) EveworldCalculatDistance(sourceGateId *big.Int, destinationGateId *big.Int) (*big.Int, error) {
	return _World.Contract.EveworldCalculatDistance(&_World.CallOpts, sourceGateId, destinationGateId)
}
...
// EveworldAggression is a paid mutator transaction binding the contract method 0x56752fbe.
//
// Solidity: function eveworld__aggression(uint256 smartTurretId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactor) EveworldAggression(opts *bind.TransactOpts, smartTurretId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__aggression", smartTurretId, priorityQueue, turret, aggressor, victim)
}

// EveworldAggression is a paid mutator transaction binding the contract method 0x56752fbe.
//
// Solidity: function eveworld__aggression(uint256 smartTurretId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldSession) EveworldAggression(smartTurretId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldAggression(&_World.TransactOpts, smartTurretId, priorityQueue, turret, aggressor, victim)
}

// EveworldAggression is a paid mutator transaction binding the contract method 0x56752fbe.
//
// Solidity: function eveworld__aggression(uint256 smartTurretId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactorSession) EveworldAggression(smartTurretId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldAggression(&_World.TransactOpts, smartTurretId, priorityQueue, turret, aggressor, victim)
}
...
//
// Solidity: function eveworld__configureSmartGate(uint256 smartGateId, bytes32 systemId) returns()
func (_World *WorldTransactor) EveworldConfigureSmartGate(opts *bind.TransactOpts, smartGateId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__configureSmartGate", smartGateId, systemId)
}

// EveworldConfigureSmartGate is a paid mutator transaction binding the contract method 0xefb17cbc.
//
// Solidity: function eveworld__configureSmartGate(uint256 smartGateId, bytes32 systemId) returns()
func (_World *WorldSession) EveworldConfigureSmartGate(smartGateId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _World.Contract.EveworldConfigureSmartGate(&_World.TransactOpts, smartGateId, systemId)
}

// EveworldConfigureSmartGate is a paid mutator transaction binding the contract method 0xefb17cbc.
//
// Solidity: function eveworld__configureSmartGate(uint256 smartGateId, bytes32 systemId) returns()
func (_World *WorldTransactorSession) EveworldConfigureSmartGate(smartGateId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _World.Contract.EveworldConfigureSmartGate(&_World.TransactOpts, smartGateId, systemId)
}

// EveworldConfigureSmartTurret is a paid mutator transaction binding the contract method 0xc0b938af.
//
// Solidity: function eveworld__configureSmartTurret(uint256 smartTurretId, bytes32 systemId) returns()
func (_World *WorldTransactor) EveworldConfigureSmartTurret(opts *bind.TransactOpts, smartTurretId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__configureSmartTurret", smartTurretId, systemId)
}

// EveworldConfigureSmartTurret is a paid mutator transaction binding the contract method 0xc0b938af.
//
// Solidity: function eveworld__configureSmartTurret(uint256 smartTurretId, bytes32 systemId) returns()
func (_World *WorldSession) EveworldConfigureSmartTurret(smartTurretId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _World.Contract.EveworldConfigureSmartTurret(&_World.TransactOpts, smartTurretId, systemId)
}

// EveworldConfigureSmartTurret is a paid mutator transaction binding the contract method 0xc0b938af.
//
// Solidity: function eveworld__configureSmartTurret(uint256 smartTurretId, bytes32 systemId) returns()
func (_World *WorldTransactorSession) EveworldConfigureSmartTurret(smartTurretId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _World.Contract.EveworldConfigureSmartTurret(&_World.TransactOpts, smartTurretId, systemId)
}

// EveworldCreateAndAnchorSmartGate is a paid mutator transaction binding the contract method 0x22414d41.
//
// Solidity: function eveworld__createAndAnchorSmartGate(uint256 smartGateId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 maxDistance) returns()
func (_World *WorldTransactor) EveworldCreateAndAnchorSmartGate(opts *bind.TransactOpts, smartGateId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, maxDistance *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createAndAnchorSmartGate", smartGateId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, maxDistance)
}

// EveworldCreateAndAnchorSmartGate is a paid mutator transaction binding the contract method 0x22414d41.
//
// Solidity: function eveworld__createAndAnchorSmartGate(uint256 smartGateId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 maxDistance) returns()
func (_World *WorldSession) EveworldCreateAndAnchorSmartGate(smartGateId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, maxDistance *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartGate(&_World.TransactOpts, smartGateId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, maxDistance)
}

// EveworldCreateAndAnchorSmartGate is a paid mutator transaction binding the contract method 0x22414d41.
//
// Solidity: function eveworld__createAndAnchorSmartGate(uint256 smartGateId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 maxDistance) returns()
func (_World *WorldTransactorSession) EveworldCreateAndAnchorSmartGate(smartGateId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, maxDistance *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartGate(&_World.TransactOpts, smartGateId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, maxDistance)
}

// EveworldCreateAndAnchorSmartStorageUnit is a paid mutator transaction binding the contract method 0xa1353e41.
//
// Solidity: function eveworld__createAndAnchorSmartStorageUnit(uint256 smartObjectId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionPerMinute, uint256 fuelMaxCapacity, uint256 storageCapacity, uint256 ephemeralStorageCapacity) returns()
func (_World *WorldTransactor) EveworldCreateAndAnchorSmartStorageUnit(opts *bind.TransactOpts, smartObjectId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionPerMinute *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createAndAnchorSmartStorageUnit", smartObjectId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionPerMinute, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}
...
func (_World *WorldSession) EveworldCreateAndAnchorSmartStorageUnit(smartObjectId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionPerMinute *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartStorageUnit(&_World.TransactOpts, smartObjectId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionPerMinute, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}
...
//
// Solidity: function eveworld__createAndAnchorSmartTurret(uint256 smartTurretId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity) returns()
func (_World *WorldTransactor) EveworldCreateAndAnchorSmartTurret(opts *bind.TransactOpts, smartTurretId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createAndAnchorSmartTurret", smartTurretId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity)
}

// EveworldCreateAndAnchorSmartTurret is a paid mutator transaction binding the contract method 0xc22f9932.
//
// Solidity: function eveworld__createAndAnchorSmartTurret(uint256 smartTurretId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity) returns()
func (_World *WorldSession) EveworldCreateAndAnchorSmartTurret(smartTurretId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartTurret(&_World.TransactOpts, smartTurretId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity)
}

// EveworldCreateAndAnchorSmartTurret is a paid mutator transaction binding the contract method 0xc22f9932.
//
// Solidity: function eveworld__createAndAnchorSmartTurret(uint256 smartTurretId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity) returns()
func (_World *WorldTransactorSession) EveworldCreateAndAnchorSmartTurret(smartTurretId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateAndAnchorSmartTurret(&_World.TransactOpts, smartTurretId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity)
}
...
// EveworldInProximity is a paid mutator transaction binding the contract method 0xf3443f83.
//
// Solidity: function eveworld__inProximity(uint256 smartTurretId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactor) EveworldInProximity(opts *bind.TransactOpts, smartTurretId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__inProximity", smartTurretId, priorityQueue, turret, turretTarget)
}

// EveworldInProximity is a paid mutator transaction binding the contract method 0xf3443f83.
//
// Solidity: function eveworld__inProximity(uint256 smartTurretId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldSession) EveworldInProximity(smartTurretId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldInProximity(&_World.TransactOpts, smartTurretId, priorityQueue, turret, turretTarget)
}

// EveworldInProximity is a paid mutator transaction binding the contract method 0xf3443f83.
//
// Solidity: function eveworld__inProximity(uint256 smartTurretId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_World *WorldTransactorSession) EveworldInProximity(smartTurretId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _World.Contract.EveworldInProximity(&_World.TransactOpts, smartTurretId, priorityQueue, turret, turretTarget)
}
...
//
// Solidity: function eveworld__registerDeployable(uint256 entityId, (address,string) smartObjectData, uint256 fuelUnitVolumeInWei, uint256 fuelConsumptionPerMinuteInWei, uint256 fuelMaxCapacityInWei) returns()
func (_World *WorldTransactor) EveworldRegisterDeployable(opts *bind.TransactOpts, entityId *big.Int, smartObjectData SmartObjectData, fuelUnitVolumeInWei *big.Int, fuelConsumptionPerMinuteInWei *big.Int, fuelMaxCapacityInWei *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__registerDeployable", entityId, smartObjectData, fuelUnitVolumeInWei, fuelConsumptionPerMinuteInWei, fuelMaxCapacityInWei)
}

// EveworldRegisterDeployable is a paid mutator transaction binding the contract method 0x2ebaa73a.
//
// Solidity: function eveworld__registerDeployable(uint256 entityId, (address,string) smartObjectData, uint256 fuelUnitVolumeInWei, uint256 fuelConsumptionPerMinuteInWei, uint256 fuelMaxCapacityInWei) returns()
func (_World *WorldSession) EveworldRegisterDeployable(entityId *big.Int, smartObjectData SmartObjectData, fuelUnitVolumeInWei *big.Int, fuelConsumptionPerMinuteInWei *big.Int, fuelMaxCapacityInWei *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldRegisterDeployable(&_World.TransactOpts, entityId, smartObjectData, fuelUnitVolumeInWei, fuelConsumptionPerMinuteInWei, fuelMaxCapacityInWei)
}

// EveworldRegisterDeployable is a paid mutator transaction binding the contract method 0x2ebaa73a.
//
// Solidity: function eveworld__registerDeployable(uint256 entityId, (address,string) smartObjectData, uint256 fuelUnitVolumeInWei, uint256 fuelConsumptionPerMinuteInWei, uint256 fuelMaxCapacityInWei) returns()
func (_World *WorldTransactorSession) EveworldRegisterDeployable(entityId *big.Int, smartObjectData SmartObjectData, fuelUnitVolumeInWei *big.Int, fuelConsumptionPerMinuteInWei *big.Int, fuelMaxCapacityInWei *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldRegisterDeployable(&_World.TransactOpts, entityId, smartObjectData, fuelUnitVolumeInWei, fuelConsumptionPerMinuteInWei, fuelMaxCapacityInWei)
}
...
// EveworldReportKill is a paid mutator transaction binding the contract method 0x76af9c6f.
//
// Solidity: function eveworld__reportKill(uint256 killMailId, (address,address,uint8,uint256,uint256) killMailTableData) returns()
...
//
// Solidity: function eveworld__setFuelConsumptionPerMinute(uint256 entityId, uint256 fuelConsumptionPerMinuteInWei) returns()
func (_World *WorldTransactor) EveworldSetFuelConsumptionPerMinute(opts *bind.TransactOpts, entityId *big.Int, fuelConsumptionPerMinuteInWei *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__setFuelConsumptionPerMinute", entityId, fuelConsumptionPerMinuteInWei)
}

// EveworldSetFuelConsumptionPerMinute is a paid mutator transaction binding the contract method 0x906c8d2d.
//
// Solidity: function eveworld__setFuelConsumptionPerMinute(uint256 entityId, uint256 fuelConsumptionPerMinuteInWei) returns()
func (_World *WorldSession) EveworldSetFuelConsumptionPerMinute(entityId *big.Int, fuelConsumptionPerMinuteInWei *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldSetFuelConsumptionPerMinute(&_World.TransactOpts, entityId, fuelConsumptionPerMinuteInWei)
}

// EveworldSetFuelConsumptionPerMinute is a paid mutator transaction binding the contract method 0x906c8d2d.
//
// Solidity: function eveworld__setFuelConsumptionPerMinute(uint256 entityId, uint256 fuelConsumptionPerMinuteInWei) returns()
func (_World *WorldTransactorSession) EveworldSetFuelConsumptionPerMinute(entityId *big.Int, fuelConsumptionPerMinuteInWei *big.Int) (*types.Transaction, error) {
	return _World.Contract.EveworldSetFuelConsumptionPerMinute(&_World.TransactOpts, entityId, fuelConsumptionPerMinuteInWei)
}

...
//
// Solidity: function evefrontier__getCurrentFuelConsumptionStatus(uint256 smartObjectId) view returns(uint256 timeLeft, uint256 unitsToConsume, uint256 actualConsumptionRateInSeconds, uint256 fuelAmount)
...
// EvefrontierConfigureFuelEfficiency is a paid mutator transaction binding the contract method 0xa74aaf9d.
//
// Solidity: function evefrontier__configureFuelEfficiency(uint256 fuelTypeId, uint256 fuelEfficiency) returns()
func (_World *WorldTransactor) EvefrontierConfigureFuelEfficiency(opts *bind.TransactOpts, fuelTypeId *big.Int, fuelEfficiency *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__configureFuelEfficiency", fuelTypeId, fuelEfficiency)
}

// EvefrontierConfigureFuelEfficiency is a paid mutator transaction binding the contract method 0xa74aaf9d.
//
// Solidity: function evefrontier__configureFuelEfficiency(uint256 fuelTypeId, uint256 fuelEfficiency) returns()
func (_World *WorldSession) EvefrontierConfigureFuelEfficiency(fuelTypeId *big.Int, fuelEfficiency *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierConfigureFuelEfficiency(&_World.TransactOpts, fuelTypeId, fuelEfficiency)
}

// EvefrontierConfigureFuelEfficiency is a paid mutator transaction binding the contract method 0xa74aaf9d.
//
// Solidity: function evefrontier__configureFuelEfficiency(uint256 fuelTypeId, uint256 fuelEfficiency) returns()
func (_World *WorldTransactorSession) EvefrontierConfigureFuelEfficiency(fuelTypeId *big.Int, fuelEfficiency *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierConfigureFuelEfficiency(&_World.TransactOpts, fuelTypeId, fuelEfficiency)
}

// EvefrontierConfigureFuelParameters is a paid mutator transaction binding the contract method 0x1e366318.
//
// Solidity: function evefrontier__configureFuelParameters(uint256 smartObjectId, (uint256,uint256,uint256,uint256,uint256) fuelParams) returns()
...
// EvefrontierConnectStructure is a paid mutator transaction binding the contract method 0x2e2a25c3.
//
// Solidity: function evefrontier__connectStructure(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldTransactor) EvefrontierConnectStructure(opts *bind.TransactOpts, networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__connectStructure", networkNodeId, structureId)
}

// EvefrontierConnectStructure is a paid mutator transaction binding the contract method 0x2e2a25c3.
//
// Solidity: function evefrontier__connectStructure(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldSession) EvefrontierConnectStructure(networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierConnectStructure(&_World.TransactOpts, networkNodeId, structureId)
}

// EvefrontierConnectStructure is a paid mutator transaction binding the contract method 0x2e2a25c3.
//
// Solidity: function evefrontier__connectStructure(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldTransactorSession) EvefrontierConnectStructure(networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierConnectStructure(&_World.TransactOpts, networkNodeId, structureId)
}
...
// EvefrontierCreateAndAnchorNetworkNode is a paid mutator transaction binding the contract method 0xbd1fd065.
//
// Solidity: function evefrontier__createAndAnchorNetworkNode((uint256,string,(bytes32,uint256,uint256,uint256),address,(uint256,uint256,uint256,uint256)) params, (uint256,uint256,uint256,uint256,uint256) fuelParams, uint256 maxEnergyCapacity, uint256 currentProduction) returns()
...
// EvefrontierHandleNodeOffline is a paid mutator transaction binding the contract method 0x2741aba3.
//
// Solidity: function evefrontier__handleNodeOffline(uint256 networkNodeId) returns()
func (_World *WorldTransactor) EvefrontierHandleNodeOffline(opts *bind.TransactOpts, networkNodeId *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__handleNodeOffline", networkNodeId)
}
...
// EvefrontierOnStructureOffline is a paid mutator transaction binding the contract method 0xa183b205.
//
// Solidity: function evefrontier__onStructureOffline(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldTransactor) EvefrontierOnStructureOffline(opts *bind.TransactOpts, networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__onStructureOffline", networkNodeId, structureId)
}

// EvefrontierOnStructureOffline is a paid mutator transaction binding the contract method 0xa183b205.
//
// Solidity: function evefrontier__onStructureOffline(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldSession) EvefrontierOnStructureOffline(networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierOnStructureOffline(&_World.TransactOpts, networkNodeId, structureId)
}

// EvefrontierOnStructureOffline is a paid mutator transaction binding the contract method 0xa183b205.
//
// Solidity: function evefrontier__onStructureOffline(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldTransactorSession) EvefrontierOnStructureOffline(networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierOnStructureOffline(&_World.TransactOpts, networkNodeId, structureId)
}

// EvefrontierOnStructureOnline is a paid mutator transaction binding the contract method 0x239f8993.
//
// Solidity: function evefrontier__onStructureOnline(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldTransactor) EvefrontierOnStructureOnline(opts *bind.TransactOpts, networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__onStructureOnline", networkNodeId, structureId)
}

// EvefrontierOnStructureOnline is a paid mutator transaction binding the contract method 0x239f8993.
//
// Solidity: function evefrontier__onStructureOnline(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldSession) EvefrontierOnStructureOnline(networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierOnStructureOnline(&_World.TransactOpts, networkNodeId, structureId)
}

// EvefrontierOnStructureOnline is a paid mutator transaction binding the contract method 0x239f8993.
//
// Solidity: function evefrontier__onStructureOnline(uint256 networkNodeId, uint256 structureId) returns()
func (_World *WorldTransactorSession) EvefrontierOnStructureOnline(networkNodeId *big.Int, structureId *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierOnStructureOnline(&_World.TransactOpts, networkNodeId, structureId)
}
...
//
// Solidity: function evefrontier__setFuelAmount(uint256 smartObjectId, uint256 fuelAmount) returns()
func (_World *WorldTransactor) EvefrontierSetFuelAmount(opts *bind.TransactOpts, smartObjectId *big.Int, fuelAmount *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__setFuelAmount", smartObjectId, fuelAmount)
}

// EvefrontierSetFuelAmount is a paid mutator transaction binding the contract method 0xa2542c4e.
//
// Solidity: function evefrontier__setFuelAmount(uint256 smartObjectId, uint256 fuelAmount) returns()
func (_World *WorldSession) EvefrontierSetFuelAmount(smartObjectId *big.Int, fuelAmount *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierSetFuelAmount(&_World.TransactOpts, smartObjectId, fuelAmount)
}

// EvefrontierSetFuelAmount is a paid mutator transaction binding the contract method 0xa2542c4e.
//
// Solidity: function evefrontier__setFuelAmount(uint256 smartObjectId, uint256 fuelAmount) returns()
func (_World *WorldTransactorSession) EvefrontierSetFuelAmount(smartObjectId *big.Int, fuelAmount *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierSetFuelAmount(&_World.TransactOpts, smartObjectId, fuelAmount)
}

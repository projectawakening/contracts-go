...
// EvefrontierRegisterDeployableClass is a paid mutator transaction binding the contract method 0xde2f736d.
//
// Solidity: function evefrontier__registerDeployableClass(uint256 typeId, uint256 volume) returns()
func (_World *WorldTransactor) EvefrontierRegisterDeployableClass(opts *bind.TransactOpts, typeId *big.Int, volume *big.Int) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "evefrontier__registerDeployableClass", typeId, volume)
}

// EvefrontierRegisterDeployableClass is a paid mutator transaction binding the contract method 0xde2f736d.
//
// Solidity: function evefrontier__registerDeployableClass(uint256 typeId, uint256 volume) returns()
func (_World *WorldSession) EvefrontierRegisterDeployableClass(typeId *big.Int, volume *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierRegisterDeployableClass(&_World.TransactOpts, typeId, volume)
}

// EvefrontierRegisterDeployableClass is a paid mutator transaction binding the contract method 0xde2f736d.
//
// Solidity: function evefrontier__registerDeployableClass(uint256 typeId, uint256 volume) returns()
func (_World *WorldTransactorSession) EvefrontierRegisterDeployableClass(typeId *big.Int, volume *big.Int) (*types.Transaction, error) {
	return _World.Contract.EvefrontierRegisterDeployableClass(&_World.TransactOpts, typeId, volume)
}

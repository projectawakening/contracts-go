...
// EveworldCreateCharacter is a paid mutator transaction binding the contract method 0xca6d734d.
//
// Solidity: function eveworld__createCharacter(uint256 characterId, address characterAddress, (uint256,uint256,uint256) entityRecord, (string,string,string) entityRecordOffchain, string tokenCid) returns()
func (_World *WorldTransactor) EveworldCreateCharacter(opts *bind.TransactOpts, characterId *big.Int, characterAddress common.Address, entityRecord EntityRecordData, entityRecordOffchain EntityRecordOffchainTableData, tokenCid string) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__createCharacter", characterId, characterAddress, entityRecord, entityRecordOffchain, tokenCid)
}

// EveworldCreateCharacter is a paid mutator transaction binding the contract method 0xca6d734d.
//
// Solidity: function eveworld__createCharacter(uint256 characterId, address characterAddress, (uint256,uint256,uint256) entityRecord, (string,string,string) entityRecordOffchain, string tokenCid) returns()
func (_World *WorldSession) EveworldCreateCharacter(characterId *big.Int, characterAddress common.Address, entityRecord EntityRecordData, entityRecordOffchain EntityRecordOffchainTableData, tokenCid string) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateCharacter(&_World.TransactOpts, characterId, characterAddress, entityRecord, entityRecordOffchain, tokenCid)
}

// EveworldCreateCharacter is a paid mutator transaction binding the contract method 0xca6d734d.
//
// Solidity: function eveworld__createCharacter(uint256 characterId, address characterAddress, (uint256,uint256,uint256) entityRecord, (string,string,string) entityRecordOffchain, string tokenCid) returns()
func (_World *WorldTransactorSession) EveworldCreateCharacter(characterId *big.Int, characterAddress common.Address, entityRecord EntityRecordData, entityRecordOffchain EntityRecordOffchainTableData, tokenCid string) (*types.Transaction, error) {
	return _World.Contract.EveworldCreateCharacter(&_World.TransactOpts, characterId, characterAddress, entityRecord, entityRecordOffchain, tokenCid)
}
...
// EveworldSetDeploybaleMetadata is a paid mutator transaction binding the contract method 0x7dab35ad.
//
// Solidity: function eveworld__setDeploybaleMetadata(uint256 smartObjectId, string name, string dappURL, string description) returns()
func (_World *WorldTransactor) EveworldSetDeploybaleMetadata(opts *bind.TransactOpts, smartObjectId *big.Int, name string, dappURL string, description string) (*types.Transaction, error) {
	return _World.contract.Transact(opts, "eveworld__setDeploybaleMetadata", smartObjectId, name, dappURL, description)
}

// EveworldSetDeploybaleMetadata is a paid mutator transaction binding the contract method 0x7dab35ad.
//
// Solidity: function eveworld__setDeploybaleMetadata(uint256 smartObjectId, string name, string dappURL, string description) returns()
func (_World *WorldSession) EveworldSetDeploybaleMetadata(smartObjectId *big.Int, name string, dappURL string, description string) (*types.Transaction, error) {
	return _World.Contract.EveworldSetDeploybaleMetadata(&_World.TransactOpts, smartObjectId, name, dappURL, description)
}

// EveworldSetDeploybaleMetadata is a paid mutator transaction binding the contract method 0x7dab35ad.
//
// Solidity: function eveworld__setDeploybaleMetadata(uint256 smartObjectId, string name, string dappURL, string description) returns()
func (_World *WorldTransactorSession) EveworldSetDeploybaleMetadata(smartObjectId *big.Int, name string, dappURL string, description string) (*types.Transaction, error) {
	return _World.Contract.EveworldSetDeploybaleMetadata(&_World.TransactOpts, smartObjectId, name, dappURL, description)
}

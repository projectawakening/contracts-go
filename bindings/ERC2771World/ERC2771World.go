...
func (_ERC2771World *ERC2771WorldTransactor) CreateCharacter(opts *bind.TransactOpts, characterId *big.Int, characterAddress common.Address, entityRecord EntityRecordData, entityRecordOffchain EntityRecordOffchainTableData, tokenCid string) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "createCharacter", characterId, characterAddress, entityRecord, entityRecordOffchain, tokenCid)
}

// CreateCharacter is a paid mutator transaction binding the contract method 0x777dd579.
//
// Solidity: function createCharacter(uint256 characterId, address characterAddress, (uint256,uint256,uint256) entityRecord, (string,string,string) entityRecordOffchain, string tokenCid) returns()
func (_ERC2771World *ERC2771WorldSession) CreateCharacter(characterId *big.Int, characterAddress common.Address, entityRecord EntityRecordData, entityRecordOffchain EntityRecordOffchainTableData, tokenCid string) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateCharacter(&_ERC2771World.TransactOpts, characterId, characterAddress, entityRecord, entityRecordOffchain, tokenCid)
}

// CreateCharacter is a paid mutator transaction binding the contract method 0x777dd579.
//
// Solidity: function createCharacter(uint256 characterId, address characterAddress, (uint256,uint256,uint256) entityRecord, (string,string,string) entityRecordOffchain, string tokenCid) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) CreateCharacter(characterId *big.Int, characterAddress common.Address, entityRecord EntityRecordData, entityRecordOffchain EntityRecordOffchainTableData, tokenCid string) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateCharacter(&_ERC2771World.TransactOpts, characterId, characterAddress, entityRecord, entityRecordOffchain, tokenCid)
}
...
func (_ERC2771World *ERC2771WorldTransactor) SetDeploybaleMetadata(opts *bind.TransactOpts, smartObjectId *big.Int, name string, dappURL string, description string) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "setDeploybaleMetadata", smartObjectId, name, dappURL, description)
}

// SetDeploybaleMetadata is a paid mutator transaction binding the contract method 0x10f38d54.
//
// Solidity: function setDeploybaleMetadata(uint256 smartObjectId, string name, string dappURL, string description) returns()
func (_ERC2771World *ERC2771WorldSession) SetDeploybaleMetadata(smartObjectId *big.Int, name string, dappURL string, description string) (*types.Transaction, error) {
	return _ERC2771World.Contract.SetDeploybaleMetadata(&_ERC2771World.TransactOpts, smartObjectId, name, dappURL, description)
}

// SetDeploybaleMetadata is a paid mutator transaction binding the contract method 0x10f38d54.
//
// Solidity: function setDeploybaleMetadata(uint256 smartObjectId, string name, string dappURL, string description) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) SetDeploybaleMetadata(smartObjectId *big.Int, name string, dappURL string, description string) (*types.Transaction, error) {
	return _ERC2771World.Contract.SetDeploybaleMetadata(&_ERC2771World.TransactOpts, smartObjectId, name, dappURL, description)
}

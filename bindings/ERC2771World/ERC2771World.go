...
// RegisterDeployableClass is a paid mutator transaction binding the contract method 0x4fffe25b.
//
// Solidity: function registerDeployableClass(uint256 typeId, uint256 volume) returns()
func (_ERC2771World *ERC2771WorldTransactor) RegisterDeployableClass(opts *bind.TransactOpts, typeId *big.Int, volume *big.Int) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "registerDeployableClass", typeId, volume)
}

// RegisterDeployableClass is a paid mutator transaction binding the contract method 0x4fffe25b.
//
// Solidity: function registerDeployableClass(uint256 typeId, uint256 volume) returns()
func (_ERC2771World *ERC2771WorldSession) RegisterDeployableClass(typeId *big.Int, volume *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.RegisterDeployableClass(&_ERC2771World.TransactOpts, typeId, volume)
}

// RegisterDeployableClass is a paid mutator transaction binding the contract method 0x4fffe25b.
//
// Solidity: function registerDeployableClass(uint256 typeId, uint256 volume) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) RegisterDeployableClass(typeId *big.Int, volume *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.RegisterDeployableClass(&_ERC2771World.TransactOpts, typeId, volume)
}

...
//
// Solidity: function aggression(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_ERC2771World *ERC2771WorldTransactor) Aggression(opts *bind.TransactOpts, smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "aggression", smartTurretId, turretOwnerCharacterId, priorityQueue, turret, aggressor, victim)
}

// Aggression is a paid mutator transaction binding the contract method 0xb9782236.
//
// Solidity: function aggression(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_ERC2771World *ERC2771WorldSession) Aggression(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _ERC2771World.Contract.Aggression(&_ERC2771World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, aggressor, victim)
}

// Aggression is a paid mutator transaction binding the contract method 0xb9782236.
//
// Solidity: function aggression(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) aggressor, (uint256,uint256,uint256,uint256,uint256,uint256) victim) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_ERC2771World *ERC2771WorldTransactorSession) Aggression(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, aggressor SmartTurretTarget, victim SmartTurretTarget) (*types.Transaction, error) {
	return _ERC2771World.Contract.Aggression(&_ERC2771World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, aggressor, victim)
}
...
//
// Solidity: function configureSmartGate(uint256 smartGateId, bytes32 systemId) returns()
func (_ERC2771World *ERC2771WorldTransactor) ConfigureSmartGate(opts *bind.TransactOpts, smartGateId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "configureSmartGate", smartGateId, systemId)
}

// ConfigureSmartGate is a paid mutator transaction binding the contract method 0xd2f7fd7a.
//
// Solidity: function configureSmartGate(uint256 smartGateId, bytes32 systemId) returns()
func (_ERC2771World *ERC2771WorldSession) ConfigureSmartGate(smartGateId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _ERC2771World.Contract.ConfigureSmartGate(&_ERC2771World.TransactOpts, smartGateId, systemId)
}

// ConfigureSmartGate is a paid mutator transaction binding the contract method 0xd2f7fd7a.
//
// Solidity: function configureSmartGate(uint256 smartGateId, bytes32 systemId) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) ConfigureSmartGate(smartGateId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _ERC2771World.Contract.ConfigureSmartGate(&_ERC2771World.TransactOpts, smartGateId, systemId)
}

// ConfigureSmartTurret is a paid mutator transaction binding the contract method 0x83340514.
//
// Solidity: function configureSmartTurret(uint256 smartTurretId, bytes32 systemId) returns()
func (_ERC2771World *ERC2771WorldTransactor) ConfigureSmartTurret(opts *bind.TransactOpts, smartTurretId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "configureSmartTurret", smartTurretId, systemId)
}

// ConfigureSmartTurret is a paid mutator transaction binding the contract method 0x83340514.
//
// Solidity: function configureSmartTurret(uint256 smartTurretId, bytes32 systemId) returns()
func (_ERC2771World *ERC2771WorldSession) ConfigureSmartTurret(smartTurretId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _ERC2771World.Contract.ConfigureSmartTurret(&_ERC2771World.TransactOpts, smartTurretId, systemId)
}

// ConfigureSmartTurret is a paid mutator transaction binding the contract method 0x83340514.
//
// Solidity: function configureSmartTurret(uint256 smartTurretId, bytes32 systemId) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) ConfigureSmartTurret(smartTurretId *big.Int, systemId [32]byte) (*types.Transaction, error) {
	return _ERC2771World.Contract.ConfigureSmartTurret(&_ERC2771World.TransactOpts, smartTurretId, systemId)
}

// CreateAndAnchorSmartGate is a paid mutator transaction binding the contract method 0xb6fbbf35.
//
// Solidity: function createAndAnchorSmartGate(uint256 smartGateId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 maxDistance) returns()
func (_ERC2771World *ERC2771WorldTransactor) CreateAndAnchorSmartGate(opts *bind.TransactOpts, smartGateId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, maxDistance *big.Int) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "createAndAnchorSmartGate", smartGateId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, maxDistance)
}

// CreateAndAnchorSmartGate is a paid mutator transaction binding the contract method 0xb6fbbf35.
//
// Solidity: function createAndAnchorSmartGate(uint256 smartGateId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 maxDistance) returns()
func (_ERC2771World *ERC2771WorldSession) CreateAndAnchorSmartGate(smartGateId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, maxDistance *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndAnchorSmartGate(&_ERC2771World.TransactOpts, smartGateId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, maxDistance)
}

// CreateAndAnchorSmartGate is a paid mutator transaction binding the contract method 0xb6fbbf35.
//
// Solidity: function createAndAnchorSmartGate(uint256 smartGateId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 maxDistance) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) CreateAndAnchorSmartGate(smartGateId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, maxDistance *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndAnchorSmartGate(&_ERC2771World.TransactOpts, smartGateId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, maxDistance)
}

// CreateAndAnchorSmartStorageUnit is a paid mutator transaction binding the contract method 0x1bd1eb3e.
//
// Solidity: function createAndAnchorSmartStorageUnit(uint256 smartStorageUnitId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 storageCapacity, uint256 ephemeralStorageCapacity) returns()
func (_ERC2771World *ERC2771WorldTransactor) CreateAndAnchorSmartStorageUnit(opts *bind.TransactOpts, smartStorageUnitId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "createAndAnchorSmartStorageUnit", smartStorageUnitId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}
...
func (_ERC2771World *ERC2771WorldSession) CreateAndAnchorSmartStorageUnit(smartStorageUnitId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndAnchorSmartStorageUnit(&_ERC2771World.TransactOpts, smartStorageUnitId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}

// CreateAndAnchorSmartStorageUnit is a paid mutator transaction binding the contract method 0x1bd1eb3e.
//
// Solidity: function createAndAnchorSmartStorageUnit(uint256 smartStorageUnitId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity, uint256 storageCapacity, uint256 ephemeralStorageCapacity) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) CreateAndAnchorSmartStorageUnit(smartStorageUnitId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int, storageCapacity *big.Int, ephemeralStorageCapacity *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndAnchorSmartStorageUnit(&_ERC2771World.TransactOpts, smartStorageUnitId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity, storageCapacity, ephemeralStorageCapacity)
}

// CreateAndAnchorSmartTurret is a paid mutator transaction binding the contract method 0xa9ceb1a1.
//
// Solidity: function createAndAnchorSmartTurret(uint256 smartTurretId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity) returns()
func (_ERC2771World *ERC2771WorldTransactor) CreateAndAnchorSmartTurret(opts *bind.TransactOpts, smartTurretId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "createAndAnchorSmartTurret", smartTurretId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity)
}

// CreateAndAnchorSmartTurret is a paid mutator transaction binding the contract method 0xa9ceb1a1.
//
// Solidity: function createAndAnchorSmartTurret(uint256 smartTurretId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity) returns()
func (_ERC2771World *ERC2771WorldSession) CreateAndAnchorSmartTurret(smartTurretId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndAnchorSmartTurret(&_ERC2771World.TransactOpts, smartTurretId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity)
}

// CreateAndAnchorSmartTurret is a paid mutator transaction binding the contract method 0xa9ceb1a1.
//
// Solidity: function createAndAnchorSmartTurret(uint256 smartTurretId, (uint256,uint256,uint256) entityRecordData, (address,string) smartObjectData, (uint256,(uint256,uint256,uint256)) worldPosition, uint256 fuelUnitVolume, uint256 fuelConsumptionIntervalInSeconds, uint256 fuelMaxCapacity) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) CreateAndAnchorSmartTurret(smartTurretId *big.Int, entityRecordData EntityRecordData, smartObjectData SmartObjectData, worldPosition WorldPosition, fuelUnitVolume *big.Int, fuelConsumptionIntervalInSeconds *big.Int, fuelMaxCapacity *big.Int) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndAnchorSmartTurret(&_ERC2771World.TransactOpts, smartTurretId, entityRecordData, smartObjectData, worldPosition, fuelUnitVolume, fuelConsumptionIntervalInSeconds, fuelMaxCapacity)
}

// CreateAndDepositItemsToEphemeralInventory is a paid mutator transaction binding the contract method 0xe111c1a6.
//
// Solidity: function createAndDepositItemsToEphemeralInventory(uint256 smartStorageUnitId, address ephemeralInventoryOwner, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_ERC2771World *ERC2771WorldTransactor) CreateAndDepositItemsToEphemeralInventory(opts *bind.TransactOpts, smartStorageUnitId *big.Int, ephemeralInventoryOwner common.Address, items []InventoryItem) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "createAndDepositItemsToEphemeralInventory", smartStorageUnitId, ephemeralInventoryOwner, items)
}

// CreateAndDepositItemsToEphemeralInventory is a paid mutator transaction binding the contract method 0xe111c1a6.
//
// Solidity: function createAndDepositItemsToEphemeralInventory(uint256 smartStorageUnitId, address ephemeralInventoryOwner, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_ERC2771World *ERC2771WorldSession) CreateAndDepositItemsToEphemeralInventory(smartStorageUnitId *big.Int, ephemeralInventoryOwner common.Address, items []InventoryItem) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndDepositItemsToEphemeralInventory(&_ERC2771World.TransactOpts, smartStorageUnitId, ephemeralInventoryOwner, items)
}

// CreateAndDepositItemsToEphemeralInventory is a paid mutator transaction binding the contract method 0xe111c1a6.
//
// Solidity: function createAndDepositItemsToEphemeralInventory(uint256 smartStorageUnitId, address ephemeralInventoryOwner, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) CreateAndDepositItemsToEphemeralInventory(smartStorageUnitId *big.Int, ephemeralInventoryOwner common.Address, items []InventoryItem) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndDepositItemsToEphemeralInventory(&_ERC2771World.TransactOpts, smartStorageUnitId, ephemeralInventoryOwner, items)
}

// CreateAndDepositItemsToInventory is a paid mutator transaction binding the contract method 0x9e19e7aa.
//
// Solidity: function createAndDepositItemsToInventory(uint256 smartStorageUnitId, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_ERC2771World *ERC2771WorldTransactor) CreateAndDepositItemsToInventory(opts *bind.TransactOpts, smartStorageUnitId *big.Int, items []InventoryItem) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "createAndDepositItemsToInventory", smartStorageUnitId, items)
}

// CreateAndDepositItemsToInventory is a paid mutator transaction binding the contract method 0x9e19e7aa.
//
// Solidity: function createAndDepositItemsToInventory(uint256 smartStorageUnitId, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_ERC2771World *ERC2771WorldSession) CreateAndDepositItemsToInventory(smartStorageUnitId *big.Int, items []InventoryItem) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndDepositItemsToInventory(&_ERC2771World.TransactOpts, smartStorageUnitId, items)
}

// CreateAndDepositItemsToInventory is a paid mutator transaction binding the contract method 0x9e19e7aa.
//
// Solidity: function createAndDepositItemsToInventory(uint256 smartStorageUnitId, (uint256,address,uint256,uint256,uint256,uint256)[] items) returns()
func (_ERC2771World *ERC2771WorldTransactorSession) CreateAndDepositItemsToInventory(smartStorageUnitId *big.Int, items []InventoryItem) (*types.Transaction, error) {
	return _ERC2771World.Contract.CreateAndDepositItemsToInventory(&_ERC2771World.TransactOpts, smartStorageUnitId, items)
}
...
//
// Solidity: function inProximity(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_ERC2771World *ERC2771WorldTransactor) InProximity(opts *bind.TransactOpts, smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _ERC2771World.contract.Transact(opts, "inProximity", smartTurretId, turretOwnerCharacterId, priorityQueue, turret, turretTarget)
}

// InProximity is a paid mutator transaction binding the contract method 0xea49f0a8.
//
// Solidity: function inProximity(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_ERC2771World *ERC2771WorldSession) InProximity(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _ERC2771World.Contract.InProximity(&_ERC2771World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, turretTarget)
}

// InProximity is a paid mutator transaction binding the contract method 0xea49f0a8.
//
// Solidity: function inProximity(uint256 smartTurretId, uint256 turretOwnerCharacterId, ((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] priorityQueue, (uint256,uint256,uint256) turret, (uint256,uint256,uint256,uint256,uint256,uint256) turretTarget) returns(((uint256,uint256,uint256,uint256,uint256,uint256),uint256)[] updatedPriorityQueue)
func (_ERC2771World *ERC2771WorldTransactorSession) InProximity(smartTurretId *big.Int, turretOwnerCharacterId *big.Int, priorityQueue []TargetPriority, turret Turret, turretTarget SmartTurretTarget) (*types.Transaction, error) {
	return _ERC2771World.Contract.InProximity(&_ERC2771World.TransactOpts, smartTurretId, turretOwnerCharacterId, priorityQueue, turret, turretTarget)
}
...
// ReportKill is a paid mutator transaction binding the contract method 0x88660e87.
//
// Solidity: function reportKill(uint256 killMailId, (address,address,uint8,uint256,uint256) killMailTableData) returns()
